...
- [The Architecture of Scale](#-the-architecture-of-scale)
  ...
  - [4. Production-Ready Safety Mechanisms](#4-production-ready-safety-mechanisms)
  - [5. Supported Algorithms](#5-supported-algorithms)
...
- **Leaky Bucket**: Similar to Token Bucket but enforces a strict output rate. Requests fill the bucket, which leaks at a constant rate. Great for traffic shaping and preventing downstream overwhelming.
